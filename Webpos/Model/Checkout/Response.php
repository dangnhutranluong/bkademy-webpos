...
class Response extends \Magento\Framework\Model\AbstractExtensibleModel implements \Bkademy\Webpos\Api\Data\Checkout\ResponseInterface
{
    /**
     * @param string $status
     * @return $this
    ...
    /**
     * @param \Bkademy\Webpos\Api\Data\Checkout\QuoteDataInterface $quoteData
     * @return $this
     */
