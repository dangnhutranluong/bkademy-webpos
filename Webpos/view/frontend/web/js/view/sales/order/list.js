define([
    ...
    'Bkademy_Webpos/js/model/sales/order/list',
], function ($, Component, storage, ko, urlBuilder, orderStatus, OrderView, priceHelper, listVar) {
    'use strict';
    ...
    return Component.extend({
        ...
        isOrderSelect: listVar.isOrderSelect,
        ...
        showList: function (pageNumber) {
            ...
            storage.get(
                ...
                if(!self.orderData.getData() || !self.orderData.getData().id) {
                    listVar.isOrderSelect(response.items[0].entity_id);
        ...
        loadOrder: function(data) {
            listVar.isOrderSelect(data.entity_id);
